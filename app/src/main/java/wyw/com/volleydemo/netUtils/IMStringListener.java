...
public class IMStringListener implements Response.Listener<String> {
    private RequestListener requestListener;
    private Context mContext;

    public IMStringListener(RequestListener requestListener) {
        this.requestListener = requestListener;
    }

    public IMStringListener(RequestListener requestListener, Context context) {
        this.requestListener = requestListener;
        mContext = context;
    }
